...
\section{Quick sanity checks (what we verified)}
We used \texttt{dump\_tokens} to sanity-check the scanner on a few representative files:
\begin{itemize}
